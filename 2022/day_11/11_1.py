...
def play_round(monkeys_items: list, operations: list, tests: list, true_decisions: list, false_decisions: list, total_items_per_monkey: list):
    for monkey_id, monkey in enumerate(monkeys_items):
        ...
        for _ in range(len(monkey)):
            ...
            worry_level = item * second_value if "*" in operation else item + second_value
            worry_level //= 3
            # Next monkey id
